...
def generate_study_pack(
    ...
    try:
        ...
        try:
            ...
            # Quality review is helpful but must not discard otherwise usable work.
            review = {
                "passed": True,
                "issues": [],
                "improvements": ["Preserve the generated content and verify requested counts."],
                "fallback_used": True,
            }
            update("4. Quality review", "Fallback completed")
        ...
        try:
            ...
            # Last-resort refinement keeps all successfully generated sections.
            final_pack = {**content, **assessment}
            update("5. Refinement", "Fallback completed")
